...
public class NewEnemy : MonoBehaviour
{
    ...
    public float secondsBetweenShooting = 1f;
    ...
    private void Start()
    {
        if (isShooting)
        {
            nextShootTime = Time.time + secondsBetweenShooting;
        }
    }
    ...
    void Update()
    {
        ...
        if (Time.time >= nextShootTime  && !isStunned)
        {
            Shoot();
        }
    ...
    void Shoot()
    {
        if (bullet)
        {
            ...
            Vector2 powerV = new Vector2(transform.localScale.x, 0f);
            ...
            nextShootTime += secondsBetweenShooting;
        }
    }
